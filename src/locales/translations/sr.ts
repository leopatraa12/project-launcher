export default {
  ...
  admin_permissions_required_modal_description:
    'Чини се да ваша GTA: San Andreas игра захтева административна права за покретање. То може бити због многих разлога, као што је инсталација игре на "C" диск. Поново отворите Kuyland Launcher као администратор користећи "Покрени као администратор" дугме или ручно сами',
