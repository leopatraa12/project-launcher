export default {
  ...
  admin_permissions_required_modal_description:
    'Միգուցե ձեր GTA: San Andreas խաղը պահանջում է ադմինիստրատորական իրավունքներ։ Դա կարող է լինել տարբեր պատճառներով, օրինակ խաղը C: սկավառակում է տեղադրված։ Խնդրում ենք նորից բացել Kuyland Launcher-ը որպես ադմինիստրատոր՝ օգտագործելով "Run as Admin" կոճակը կամ ձեռքով։',
