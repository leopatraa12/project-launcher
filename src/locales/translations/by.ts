export default {
  ...
  admin_permissions_required_modal_description:
    'Падобна на тое, што для запуску GTA: San Andreas патрабуюцца правы адміністратара. Гэта можа адбыцца па розных прычынах, напрыклад, калі ваша гульня ўстаноўлена на дыску "C". Калі ласка, адкрыйце Kuyland Launcher паўторна ад імя адміністратара з дапамогай кнопкі" Запуск ад імя адміністратара " альбо ўручную',
