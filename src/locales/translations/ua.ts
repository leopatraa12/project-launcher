export default {
  ...
  admin_permissions_required_modal_description:
    'Схоже, що для запуску GTA: San Andreas потрібні права адміністратора. Це може статися з різних причин, наприклад, якщо ваша гра встановлена на диску "C". Будь ласка, відкрийте Kuyland Launcher повторно від імені адміністратора за допомогою кнопки "Запуск від імені адміністратора" або вручну.',
