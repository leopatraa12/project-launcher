export default {
  ...
  admin_permissions_required_modal_description:
    'يبدو أن لعبة GTA: San Andreas الخاصة بك تتطلب أذونات إدارية للتشغيل. يمكن أن يكون هذا بسبب العديد من الأسباب ، مثل تثبيت لعبتك في محرك الأقراص "C". يرجى إعادة فتح مشغل Kuyland كأدمن إما باستخدام زر "تشغيل كأدمن" أو يدويا بنفسك',
